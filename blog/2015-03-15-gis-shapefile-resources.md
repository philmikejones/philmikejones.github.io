...
No list of GIS resources would be complete without [QGIS](http://www.qgis.o../_static/site/), which is a free and open source GIS package, comparable to ArcGIS (and in my opinion, superior).
